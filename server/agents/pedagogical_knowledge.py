...
def analyze_and_respond(
    ...
    # ═════════════════════════════════════════════════════════════════════════
    if any(k in msg_lower for k in ["умеешь", "можешь", "что это", "помоги", "help", "как работаешь"]):
        reply = (
            "Привет! Я твой напарник-методист по урокам английского. 😊\n\n"
            "С удовольствием помогу:\n"
            "• Вести досье постоянных учеников, помнить их уровень, успехи и трудности по твоим фидбекам.\n"
            "• Придумывать интерактивные материалы для доски FigJam — от быстрых разминок до квизов и карточек.\n"
            "• Учитывать твои пожелания и нюансы перед каждым созданием на холсте.\n\n"
    ...
    # ═════════════════════════════════════════════════════════════════════════
    reply = (
        f"Интересная мысль! Расскажи чуть подробнее: для кого готовим это задание и что именно ты хотел бы видеть на доске? 🤔\n\n"
        f"Назови постоянного ученика (например «для Маши») или выбери формат: быстрая игра/викторина, разговорная практика или грамматика?"
    )
    return {
        "reply": reply,
        "suggested_replies": [
